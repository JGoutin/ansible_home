...
| `nextcloud_applications`        | [`admin_audit`, `bruteforcesettings`, `calendar`, `circles`, `contacts`, `deck`, `encryption`, `end_to_end_encryption`, `files_accesscontrol`, `files_antivirus`, `files_automatedtagging`, `files_external`, `files_retention`, `groupfolders`, `mail`, `maps`, `notes`, `spreed`, `suspicious_login`, `tasks`, `twofactor_totp`, `twofactor_webauthn`] | Install the specified list of Nextcloud applications. Default to Nextcloud Hub applications and some common applications.                                           |
...
| `nextcloud_twofactor_enforced`  | true                                                                                                                                                                                                                                                                                                                                                | If `true`, enforce two factor authentication to improve security.                                                                                                   |
